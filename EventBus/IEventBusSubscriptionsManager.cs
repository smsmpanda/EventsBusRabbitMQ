...
namespace EventBus
{
    public interface IEventBusSubscriptionsManager
    {
        ...
        void AddSubscription<T, TH>() where T : IntegrationEvent where TH : IEventHandle<T>;

        void RemoveSubscription<T, TH>() where TH : IEventHandle<T> where T : IntegrationEvent;
